...
class Tests(unittest.TestCase):
    def test_main(self):
        def llamar_funciones(texto_a_ocultar, txt_esperado):
            ...
            main.ocultar_texto_en_imagen("texto.txt", "fac.png", "fac_mod.png")
            main.develar_texto_en_imagen("fac_mod.png", "txt_develado.txt")
    ...
    def test_texto_muy_largo(self):
        ...
        self.assertRaises(
            ...
            ["texto_muy_largo.txt", "fac.png", "fac_mod.png"],
        )
